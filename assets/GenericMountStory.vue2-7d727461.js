...
const file$2 = "src/stories/AISTrackSymbol.story.svelte";
function create_default_slot$2(ctx) {
  ...
  const block = {
    c: function create() {
      div = element("div");
      attr_dev(div, "id", "map");
      add_location(div, file$2, 108, 4, 2347);
    },
...
function create_controls_slot$2(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      add_location(h30, file$2, 112, 8, 2443);
      attr_dev(button0, "class", "htw-p-2");
      add_location(button0, file$2, 116, 8, 2712);
      add_location(h31, file$2, 118, 8, 2790);
      attr_dev(button1, "class", "htw-p-2");
      add_location(button1, file$2, 122, 8, 3059);
    },
    m: function mount(target, anchor) {
...
const AISTrackSymbolWithData_story_svelte_svelte_type_style_lang = "";
const file$1 = "src/stories/AISTrackSymbolWithData.story.svelte";
function create_default_slot$1(ctx) {
  ...
  const block = {
    c: function create() {
      div = element("div");
      attr_dev(div, "id", "map");
      add_location(div, file$1, 89, 4, 3170);
    },
    m: function mount(target, anchor) {
      insert_dev(target, div, anchor);
      ctx[5](div);
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(89:0) <Hst.Story title=\\"AIStrackSymbol (with data)\\" group=\\"layers\\">',
    ctx
  });
  return block;
}
function create_controls_slot$1(ctx) {
  ...
  let hst_json_props = { title: "AIS data (JSON)" };
  if (ctx[1] !== void 0) {
    hst_json_props.value = ctx[1];
  }
  hst_json = new ctx[0].Json({ props: hst_json_props, $$inline: true });
  binding_callbacks.push(() => bind(hst_json, "value", hst_json_value_binding, ctx[1]));
  const block = {
    c: function create() {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(93:4) <svelte:fragment slot=\\"controls\\">',
    ctx
  });
  return block;
}
function create_fragment$1(ctx) {
  ...
  hst_story = new ctx[0].Story({
    props: {
      title: "AIStrackSymbol (with data)",
      group: "layers",
      $$slots: {
...
function instance$1($$self, $$props, $$invalidate) {
  let { $$slots: slots = {}, $$scope } = $$props;
  validate_slots("AISTrackSymbolWithData_story", slots, []);
  let { Hst } = $$props;
  let mapElement;
  let map;
  let center = [1.251, 103.826];
  ...
  onMount(() => {
    ...
    map = leafletSrcExports.map(mapElement, { center, zoom: 13 });
    leafletSrcExports.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png", {
      attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
    }).addTo(map);
    $$invalidate(3, layerGroup = new leafletSrcExports.LayerGroup());
    layerGroup.addTo(map);
  });
  $$self.$$.on_mount.push(function() {
    if (Hst === void 0 && !("Hst" in $$props || $$self.$$.bound[$$self.$$.props["Hst"]])) {
      console.warn("<AISTrackSymbolWithData_story> was created without expected prop 'Hst'");
    }
  });
  const writable_props = ["Hst"];
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<AISTrackSymbolWithData_story> was created with unknown prop '${key}'`);
  });
  function hst_json_value_binding(value) {
    entries = value;
  ...
  $$self.$capture_state = () => ({
    onMount,
    L: leafletSrcExports,
    LayerGroup: leafletSrcExports.LayerGroup,
    LeafletMap: leafletSrcExports.Map,
    AISTrackSymbol,
    Hst,
    mapElement,
  ...
  $$self.$inject_state = ($$props2) => {
    if ("Hst" in $$props2)
      $$invalidate(0, Hst = $$props2.Hst);
    if ("mapElement" in $$props2)
      $$invalidate(2, mapElement = $$props2.mapElement);
    if ("map" in $$props2)
      map = $$props2.map;
    if ("center" in $$props2)
      center = $$props2.center;
    if ("layerGroup" in $$props2)
      $$invalidate(3, layerGroup = $$props2.layerGroup);
    if ("entries" in $$props2)
      $$invalidate(1, entries = $$props2.entries);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
    ...
    if ($$self.$$.dirty & 10) {
      {
        if (layerGroup != null) {
          ...
          if (entries !== null && entries !== void 0 && entries.entries !== null && entries.entries !== void 0) {
            entries.entries.forEach((entry) => {
              ...
              const ts = new AISTrackSymbol(positionReport, { shipStaticData });
  ...
  return [Hst, entries, mapElement, layerGroup, hst_json_value_binding, div_binding];
}
class AISTrackSymbolWithData_story extends SvelteComponentDev {
  constructor(options) {
    super(options);
    init(this, options, instance$1, create_fragment$1, safe_not_equal, { Hst: 0 });
    dispatch_dev("SvelteRegisterComponent", {
      component: this,
      tagName: "AISTrackSymbolWithData_story",
      options,
      id: create_fragment$1.name
    });
  }
  get Hst() {
    throw new Error("<AISTrackSymbolWithData_story>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  set Hst(value) {
    throw new Error("<AISTrackSymbolWithData_story>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
}
...
const Comp3 = { "title": "HTML usage", "icon": "carbon:bookmark", "group": "usage", "docsOnly": true, "variants": [] };
const Comp4 = { "title": "Introduction", "icon": "carbon:bookmark", "group": "top", "docsOnly": true, "variants": [] };
let files = [
  ...
  { "id": "src-stories-aistracksymbolwithdata-story-svelte", "path": ["AIStrackSymbol (with data)"], "filePath": "src/stories/AISTrackSymbolWithData.story.svelte", "story": { "id": "src-stories-aistracksymbolwithdata-story-svelte", "title": "AIStrackSymbol (with data)", "group": "layers", "layout": { "type": "single", "iframe": true }, "icon": null, "iconColor": null, "docsOnly": false, "variants": [{ "id": "_default", "title": "default" }] }, "supportPluginId": "svelte3", "index": 1, component: AISTrackSymbolWithData_story, source: () => __vitePreload(() => import("./__resolved__virtual_story-source_src-stories-aistracksymbolwithdata-story-svelte-97db75c5.js"), true ? [] : void 0) },
  { "id": "src-stories-tracksymbol-story-svelte", "path": ["TrackSymbol"], "filePath": "src/stories/TrackSymbol.story.svelte", "story": { "id": "src-stories-tracksymbol-story-svelte", "title": "TrackSymbol", "group": "layers", "layout": { "type": "single", "iframe": true }, "icon": null, "iconColor": null, "docsOnly": false, "variants": [{ "id": "_default", "title": "default" }] }, "supportPluginId": "svelte3", "index": 2, component: TrackSymbol_story, source: () => __vitePreload(() => import("./__resolved__virtual_story-source_src-stories-tracksymbol-story-svelte-d9c0dc45.js"), true ? [] : void 0) },
  { "id": "src-stories-htmlusage-story-js", "path": ["HTML usage"], "filePath": "src/stories/HtmlUsage.story.js", "story": { "id": "src-stories-htmlusage-story-js", "title": "HTML usage", "group": "usage", "layout": { "type": "single", "iframe": true }, "icon": "carbon:bookmark", "docsOnly": true, "variants": [] }, "supportPluginId": "vanilla", "index": 3, component: Comp3, source: () => __vitePreload(() => import("./__resolved__virtual_story-source_src-stories-htmlusage-story-js-f43d4315.js"), true ? [] : void 0) },
  { "id": "src-stories-introduction-story-js", "path": ["Introduction"], "filePath": "src/stories/Introduction.story.js", "story": { "id": "src-stories-introduction-story-js", "title": "Introduction", "group": "top", "layout": { "type": "single", "iframe": true }, "icon": "carbon:bookmark", "docsOnly": true, "variants": [] }, "supportPluginId": "vanilla", "index": 4, component: Comp4, source: () => __vitePreload(() => import("./__resolved__virtual_story-source_src-stories-introduction-story-js-310c24de.js"), true ? [] : void 0) }
];
let tree = [{ "group": true, "id": "top", "title": "", "children": [{ "title": "Introduction", "index": 4 }] }, { "group": true, "id": "usage", "title": "", "children": [{ "title": "HTML usage", "index": 3 }] }, { "group": true, "id": "layers", "title": "Layers", "children": [{ "title": "AISTrackSymbol", "index": 0 }, { "title": "AIStrackSymbol (with data)", "index": 1 }, { "title": "TrackSymbol", "index": 2 }] }];
const config = { "plugins": [{ "name": "builtin:tailwind-tokens" }, { "name": "builtin:vanilla-support", "supportPlugin": { "id": "vanilla", "moduleName": "/home/nick/Code/org-arl/leaflet-tracksymbol2/node_modules/.pnpm/histoire@0.12.4_vite@4.0.4/node_modules/histoire/dist/node/builtin-plugins/vanilla-support", "setupFn": "setupVanilla" } }, { "name": "@histoire/plugin-svelte", "supportPlugin": { "id": "svelte3", "moduleName": "@histoire/plugin-svelte", "setupFn": "setupSvelte3" } }], "outDir": "/home/nick/Code/org-arl/leaflet-tracksymbol2/build/histoire", "storyMatch": ["**/*.story.vue", "**/*.story.svelte"], "storyIgnored": ["**/node_modules/**", "**/dist/**"], "supportMatch": [{ "id": "vanilla", "patterns": ["**/*.js"], "pluginIds": ["vanilla"] }, { "id": "svelte", "patterns": ["**/*.svelte"], "pluginIds": ["svelte3"] }], "tree": { "file": "title", "order": "asc", "groups": [{ "id": "top", "title": "" }, { "id": "usage", "title": "" }, { "id": "layers", "title": "Layers" }] }, "theme": { "title": "Histoire", "colors": { "primary": { "50": "#fff7ed", "100": "#ffedd5", "200": "#fed7aa", "300": "#fdba74", "400": "#fb923c", "500": "#f97316", "600": "#ea580c", "700": "#c2410c", "800": "#9a3412", "900": "#7c2d12" }, "gray": { "50": "#fafafa", "100": "#f4f4f5", "200": "#e4e4e7", "300": "#d4d4d8", "400": "#a1a1aa", "500": "#71717a", "600": "#52525b", "700": "#3f3f46", "750": "#323238", "800": "#27272a", "850": "#1f1f21", "900": "#18181b", "950": "#101012" } }, "logo": { "square": "@histoire/plugin-svelte/assets/histoire-svelte.svg", "light": "@histoire/plugin-svelte/assets/histoire-svelte-text.svg", "dark": "@histoire/plugin-svelte/assets/histoire-svelte-text.svg" } }, "responsivePresets": [{ "label": "Mobile (Small)", "width": 320, "height": 560 }, { "label": "Mobile (Medium)", "width": 360, "height": 640 }, { "label": "Mobile (Large)", "width": 414, "height": 896 }, { "label": "Tablet", "width": 768, "height": 1024 }, { "label": "Laptop (Small)", "width": 1024, "height": null }, { "label": "Laptop (Large)", "width": 1366, "height": null }, { "label": "Desktop", "width": 1920, "height": null }, { "label": "4K", "width": 3840, "height": null }], "backgroundPresets": [{ "label": "Transparent", "color": "transparent", "contrastColor": "#333" }, { "label": "White", "color": "#fff", "contrastColor": "#333" }, { "label": "Light gray", "color": "#aaa", "contrastColor": "#000" }, { "label": "Dark gray", "color": "#333", "contrastColor": "#fff" }, { "label": "Black", "color": "#000", "contrastColor": "#eee" }], "sandboxDarkClass": "dark", "routerMode": "hash", "vite": { "base": "/" }, "viteIgnorePlugins": ["vite-plugin-sveltekit-compile"], "setupFile": "src/stories/setup.ts" };
...
const clientSupportPlugins = {
  "vanilla": () => __vitePreload(() => import("./vendor-38064dc5.js").then((n) => n.aT), true ? [] : void 0),
  "svelte3": () => __vitePreload(() => import("./vendor-38064dc5.js").then((n) => n.aU), true ? [] : void 0)
};
const __default__ = {
  inheritAttrs: false
};
...
//# sourceMappingURL=GenericMountStory.vue2-7d727461.js.map
